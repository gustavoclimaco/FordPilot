...
from openpilot.selfdrive.car.gwm.values import CAR as GWM
...
Platform = BODY | CHRYSLER | FORD | GM | GWM | HONDA | HYUNDAI | MAZDA | MOCK | NISSAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
